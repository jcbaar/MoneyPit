...
public class RecyclerViewEx extends RecyclerView {
    ...
    public RecyclerViewEx(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            ...
            try {
                left = (int)a.getDimension(R.styleable.RecyclerViewEx_itemPaddingLeft, 0);
                top = (int)a.getDimension(R.styleable.RecyclerViewEx_itemPaddingTop, 0);
                right = (int)a.getDimension(R.styleable.RecyclerViewEx_itemPaddingRight, 0);
                bottom = (int)a.getDimension(R.styleable.RecyclerViewEx_itemPaddingBottom, 0);
            } catch (Exception e) {

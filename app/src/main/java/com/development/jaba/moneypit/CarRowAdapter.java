...
public class CarRowAdapter extends ArrayAdapter<Car> {
    ...
    /**
     * Overide fior the getView() method. This will setup a view with the contents
     * of the row.
     * @param position The position to setup the view for.
     * @param convertView The vierw to convert.
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View rowView = rowInflater.inflate(R.layout.car_row_template, parent, false);
